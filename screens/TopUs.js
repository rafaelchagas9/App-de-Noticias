...
class TopUs extends Component {
  ...
  constructor(props) {
    ...
    this.state={ 
      ...
      isLoading: true,
      page: 1 // Checa se o Json está carregando
    }
  } 
  ...
  makeRequest = async () => {
    ...
    axios.get(`https://newsapi.org/v2/top-headlines?country=us&pageSize=10&page=${this.state.page}&apiKey=4a9888460f184e599a97ed2a0dda9a26`)
    .then(response => {
